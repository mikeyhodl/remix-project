...
module.exports = {
  ...
  'Test yarn.lock change detection #group5': function (browser: NightwatchBrowser) {
    browser
      .clickLaunchIcon('filePanel')
      ...
      .click('*[data-id="treeViewDivDraggableItem.deps/npm"]')
      .click('*[data-id="treeViewDivDraggableItem.deps/npm/@openzeppelin"]')
      // Should now use the NEW version from updated yarn.lock (4.7.3)
      .waitForElementPresent('*[data-id^="treeViewDivDraggableItem.deps/npm/@openzeppelin/contracts@4.7"]', 10000)
      .end()
  },
  ...
  'Test package-lock.json change detection #group6': function (browser: NightwatchBrowser) {
    browser
      .clickLaunchIcon('filePanel')
      ...
      .click('*[data-id="treeViewDivDraggableItem.deps/npm"]')
      .click('*[data-id="treeViewDivDraggableItem.deps/npm/@openzeppelin"]')
      // Should now use the NEW version from updated package-lock.json (4.6.0)
      .waitForElementPresent('*[data-id^="treeViewDivDraggableItem.deps/npm/@openzeppelin/contracts@4.6"]', 10000)
      .end()
  }
}
