...
export class RunTab extends ViewPlugin {
  ...
  async onInitDone() {
    ...
    await addProvider(4, 'vm-mainnet-fork', 'Remix VM - Mainnet fork', { isInjected: false, isVM: true, isVMStateForked: true, isRpcForkedState: true, fork: 'prague' }, 'settingsVMMainnetMode', titleVM)
    await addProvider(5, 'vm-sepolia-fork', 'Remix VM - Sepolia fork', { isInjected: false, isVM: true, isVMStateForked: true, isRpcForkedState: true, fork: 'prague' }, 'settingsVMSepoliaMode', titleVM)
