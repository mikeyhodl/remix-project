...
/**
 * Normalize GitHub blob URLs to raw.githubusercontent.com
 */
...
/**
 * Detect unpkg/jsDelivr npm CDN URLs and rewrite to npm-style path
 * Returns npmPath like "@scope/pkg@1.2.3/path/to/file.sol" or "@scope/pkg/path/to/file.sol"
 */
export function rewriteNpmCdnUrl(url: string): NpmCdnRewrite | null {
  // Versioned pattern first
...
/**
 * Normalize raw.githubusercontent.com URL to a stable internal path for saving
 * Produces "github/owner/repo@ref/path" and returns owner/repo/ref/filePath breakdown
 */
...
/** Normalize IPFS URLs to ipfs/<hash>/<path> */
...
/** Normalize Swarm URLs to swarm/<hash>/<path> */
