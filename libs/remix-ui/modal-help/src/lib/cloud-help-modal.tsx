      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
        {isCloud ? (
          ...
          <>
            ...
            <Trait positive={false}>No sync, no backup</Trait>
      ...
      >
        ...
        >
          ...
          {picked === "local" && (
            ...
            >
              <PanelHeader dotColor={c.tm} title="Local workspace actions" tagText="Browser" tagColor={c.tm} />
              <div style={{ padding: 14, display: "flex", flexDirection: "column", gap: 6 }}>
                <ActionRow
                  icon={<UploadIcon color={c.bl} />}
                  iconBg="rgba(91,156,245,0.1)"
                  name="Migrate to cloud"
                  desc="Copy this workspace to the cloud. Do it whenever you want — completely optional."
          ...
          {picked === "cloud" && (
            ...
            >
              <PanelHeader dotColor={c.bl} title="Cloud workspace actions" tagText="Synced" tagColor={c.bl} />
              <div style={{ padding: 14, display: "flex", flexDirection: "column", gap: 6 }}>
                <ActionRow
                  ...
                  right={
                    <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 9, color: c.gn }}>
                      Always on
                    </span>
                  }
                />
                ...
                <ActionRow
                  ...
                  iconBg="rgba(91,156,245,0.1)"
                  name="Create new cloud workspace"
                  desc="Start fresh — cloud-first from the beginning."
                ...
                <ActionRow
                  ...
                  desc="Move existing browser workspaces to the cloud. Pick which ones — your call."
                  onClick={() => handleAction("migrate")}
                />
                <Separator />
                <ActionRow
                  ...
                  desc="Save a point-in-time backup of any cloud workspace as a zip."
